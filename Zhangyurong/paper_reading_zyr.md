...
<<<<<<< HEAD
- **L. Yang and A. Shami, "A Transfer Learning and Optimized CNN Based Intrusion Detection System for Internet of Vehicles," ICC 2022 - IEEE International Conference on Communications, Seoul, Korea, Republic of, 2022, pp. 2774-2779, doi: 10.1109/ICC45855.2022.9838780. keywords: {Adaptation models;Connected vehicles;Transfer learning;Transforms;Telecommunication traffic;Benchmark testing;Data models;Intrusion Detection System;Internet of Vehicles;CNN;Transfer Learning;Ensemble learning;Particle Swarm Optimization},[[paper]](https://ieeexplore.ieee.org/document/9838780)[[code]](https://github.com/Western-OC2-Lab/Intrusion-Detection-System-Using-CNN-and-Transfer-Learning)[[笔记]](<../../../车联网安全/detection/A Transfer Learning and Optimized CNN Based.docx>)**
```
注：ICC 2022
1. 研究背景与目的：
...
```
- **K. Agrawal, T. Alladi, A. Agrawal, V. Chamola and A. Benslimane, "NovelADS: A Novel Anomaly Detection System for Intra-Vehicular Networks," in IEEE Transactions on Intelligent Transportation Systems, vol. 23, no. 11, pp. 22596-22606, Nov. 2022, doi: 10.1109/TITS.2022.3146024.
keywords: {Feature extraction;Protocols;Anomaly detection;Deep learning;Intrusion detection;Computational modeling;Convolution;Controller area network (CAN);intelligent transportation system;anomaly detection;network security},[[paper]](https://ieeexplore.ieee.org/document/9706416)[[code]](https://github.com/kushagra-2503/Artificial-Intelligence-Enabled-SecurityProvisioning-for-Autonomous-Vehicles)**
```
注：TITS.2022
...
- **A. Boualouache and T. Engel, "A Survey on Machine Learning-Based Misbehavior Detection Systems for 5G and Beyond Vehicular Networks," in IEEE Communications Surveys & Tutorials, vol. 25, no. 2, pp. 1128-1172, Secondquarter 2023, doi: 10.1109/COMST.2023.3236448.
keywords: {Vehicle-to-everything;Security;Fake news;Protocols;5G mobile communication;Machine learning;Global Positioning System;Surveys;5G and beyond;connected and automated vehicles;machine learning;misbehavior detection systems;security;vehicle-to-everything},[[paper]](https://ieeexplore.ieee.org/document/10015746)**
```
...
```
- **R. Sedar, C. Kalalas, P. Dini, J. Alonso–Zarate and F. Vázquez–Gallego, "Misbehavior Detection in Vehicular Networks: An Ensemble Learning Approach," GLOBECOM 2022 - 2022 IEEE Global Communications Conference, Rio de Janeiro, Brazil, 2022, pp. 1850-1855, doi: 10.1109/GLOBECOM48099.2022.10001264. keywords: {Training data;Reinforcement learning;Real-time systems;Robustness;Behavioral sciences;Ensemble learning;Security;Misbehavior detection;V2X;K-means;RL},
...
```
- **R. Sedar, C. Kalalas, F. Vázquez-Gallego and J. Alonso-Zarate, "Reinforcement Learning Based Misbehavior Detection in Vehicular Networks," ICC 2022 - IEEE International Conference on Communications, Seoul, Korea, Republic of, 2022, pp. 3550-3555, doi: 10.1109/ICC45855.2022.9838796. keywords: {Measurement;Reinforcement learning;Benchmark testing;Road safety;Real-time systems;Data models;Security;V2X;IoV;Misbehavior Detection;Reinforcement Learning},[[paper]](https://ieeexplore.ieee.org/document/9838796)**
```
注：ICC 2022
1. 研究背景与目的：
...
>>>>>>> 1c33420ec320d1d2b09295a2d648e7b85e6b4905
